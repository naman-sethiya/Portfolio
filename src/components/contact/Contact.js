...
const Contact = () => {
  ...
  return (
    <section
      id="contact"
      className="w-full py-20 border-b-[1px] border-b-black -mt-40"
         ...
         <div className="w-full lgl:w-[60%] h-full py-10 flex flex-col gap-8 p-4 lgl:p-8 rounded-lg shadow-shadowOne">
            <form className="w-full flex flex-col gap-4 lgl:gap-6 py-2 lgl:py-5">
              ...
              <div className="w-full">
                <button
                  onClick={handleSend}
                  className="w-full h-12 bg-[#ff014f] rounded-lg text-base text-white tracking-wider uppercase hover:text-black duration-300 hover:border-[1px] hover:border-designColor border-transparent"
                >
                  Send Message
                </button>
              </div>
